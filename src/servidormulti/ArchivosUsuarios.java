...
public class ArchivosUsuarios {
    ...
    public boolean escribirUsuarios(String usuario, String contra) {
        ...
        try (PrintWriter escribir = new PrintWriter(new FileWriter(ArchivosUsuarios, true))) {
            escribir.println(usuario + ":" + contra + ":" + status);
            return true;
        } catch (Exception e) {
...
boolean existe = ExisteUsuario(usuario,contra);
if (existe)return true;
    ...
    public boolean ExisteUsuario(String usuario, String contra) {
        ...
        try {
            ...
            System.out.println("Algo paso al leer el archivo en el ExisteUsuario");
        }
