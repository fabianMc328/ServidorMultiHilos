...
public class ConexionBD {
    ...
    static {
        ...
        try {
            ...
            System.err.println("Error crítico al crear las tablas de la BD.");
            e.printStackTrace();
    ...
    private static void crearTablasSiNoExisten() throws SQLException {
        ...
        String sqlGrupoTodos = "INSERT OR IGNORE INTO grupos (id_grupo, nombre_grupo, creador_usuario) " +
                "VALUES (1, 'todos', NULL);";

        String sqlMembresias = "CREATE TABLE IF NOT EXISTS membresias_grupo (" +
                "id_usuario TEXT NOT NULL," +
                "id_grupo INTEGER NOT NULL," +
                "PRIMARY KEY (id_usuario, id_grupo)" +
                ");";

        String sqlMensajes = "CREATE TABLE IF NOT EXISTS mensajes_grupo (" +
        ...
        String sqlEstadoLectura = "CREATE TABLE IF NOT EXISTS estado_lectura (" +
                "id_usuario TEXT NOT NULL," +
                "id_grupo INTEGER NOT NULL," +
                "ultimo_mensaje_visto_id INTEGER NOT NULL," +
                "PRIMARY KEY (id_usuario, id_grupo)" +
                ");";

        String sqlRanking = "CREATE TABLE IF NOT EXISTS ranking_gato (" +
                "usuario TEXT PRIMARY KEY NOT NULL," +
        ...
        String sqlH2H = "CREATE TABLE IF NOT EXISTS h2h_gato (" +
                "jugador1 TEXT NOT NULL," +
                "jugador2 TEXT NOT NULL," +
                "victorias_jugador1 INTEGER DEFAULT 0," +
                "victorias_jugador2 INTEGER DEFAULT 0," +
                "empates INTEGER DEFAULT 0," +
        ...
        try (Connection conn = getConnection();
            ...
            stmt.execute(sqlGrupoTodos);
            stmt.execute(sqlMembresias);
            stmt.execute(sqlMensajes);
            stmt.execute(sqlEstadoLectura);
    ...
    public static void testConnection() {
        try (Connection conn = getConnection()) {
            ...
            System.err.println("Error conectando a la base de datos SQLite:");
            e.printStackTrace();
        }
    }
}